...
class Ui_email(object):
    def setupUi(self, email):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(20, 60, 351, 20))
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(20, 120, 351, 20))
    ...
    def retranslateUi(self, email):
        ...
        self.label.setText(_translate("email", "이메일 보내기", None))
        self.pushButton.setText(_translate("email", "뒤로가기", None))
        self.groupBox.setTitle(_translate("email", "메일 보내기 정보 입력", None))
        self.label_2.setText(_translate("email", "받고자 하는 메일 주소", None))
        self.label_3.setText(_translate("email", "메일 제목", None))
